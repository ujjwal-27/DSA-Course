...
public class Main {
    ...
    public static void sortStack(Stack<Integer> originalStack) {
        ...
        // Following this concept, this loop will execute until original stack is empty.
        while (!originalStack.isEmpty()) {
            ...
            // If the sorted stack is empty, or the top element of original stack (current element) is greater than top element of sorted stack, then add the current element to sorted stack
            if (peekSortedStack == null || originalTopElement > peekSortedStack) {
                sortedStack.push(originalTopElement);

            // If the current element is smaller than the top element of sorted stack, this code block will execute
            } else {
                // This loop will execute until the sorted stack is not empty, and current element is less than top elements of sorted stack from each iteration.
